...
public class Test {
    public static void main(String[] args) {
        ...
        //设置预约
        Reservation r1= new Reservation(car1,new Date(2019-1900,7,11,15,00,0));
        Reservation r2= new Reservation(car2,new Date(2019-1900,7,14,12,00,0));
        Reservation r3= new Reservation(car3,new Date(2019-1900,7,12,11,00,0));
        //写入预约信息
