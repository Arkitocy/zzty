...
public class ProductTest {
    public static void main(String[] args) {
        Product product1 = new Product("产品5", "日用", new Date(), new Date(2019 - 1900, 10, 11, 15, 00, 0));
        Product product2 = new Product("产品4", "万用", new Date(), new Date(2019 - 1900, 10, 11, 15, 00, 0));
